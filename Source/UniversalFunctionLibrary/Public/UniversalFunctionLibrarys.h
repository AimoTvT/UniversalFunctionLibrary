...
public:
	...
	/** 字符串转换Vector2D */
	UFUNCTION(BlueprintPure, Category = "Aimo|Static|Miscellaneous")
		static FVector2D StringToVector2D(FString SourceString);

	/** Vector2DXY交换 */
	UFUNCTION(BlueprintPure, Category = "Aimo|Static|Miscellaneous")
		static FVector2D Vector2DSwapXY(FVector2D SwapVector2D);
	...
	/** 生成的演员 */
	static AActor* SpawnActor(UClass* Class, FTransform const& Transform, AActor* Owner = nullptr, APawn* Instigator = nullptr);
	static AActor* SpawnActor(UClass* Class, FVector Location, FRotator Rotation = { 0.0, 0.0, 0.0 }, FVector Scale3D = {1.0, 1.0, 1.0}, AActor* Owner = nullptr, APawn* Instigator = nullptr);
