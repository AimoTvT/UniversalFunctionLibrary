...
public:
	...
	/** 设置Widget控件位置 */
	UFUNCTION(BlueprintCallable, Category = "Aimo|Static|Wdiget")
		static void SetWidgetPosition(UWidget* Widget, FVector2D Position);

	/** 设置Image资源 */
	UFUNCTION(BlueprintCallable, Category = "Aimo|Static|Wdiget")
		static void SetWidgetSize(UWidget* Widget, FVector2D Size, USizeBox* SizeBox = nullptr);

	/** 设置Image资源 */
	UFUNCTION(BlueprintCallable, Category = "Aimo|Static|Wdiget")
		static void SetImageResource(UImage* Image, UObject* Resource, FName ParameterName = "MaterialTexture");
