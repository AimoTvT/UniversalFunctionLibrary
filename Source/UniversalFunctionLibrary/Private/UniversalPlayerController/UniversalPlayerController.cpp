...
#include "UniversalPlayerController/UniversalPlayerController.h"
#include "UniversalLibrarySystem/UniversalLibrarySystem.h"

void AUniversalPlayerController::BeginPlay()
{
	Super::BeginPlay();
	
	if (IsLocalController() && UUniversalLibrarySystem::Get())
	{
		UUniversalLibrarySystem::Get()->PlayGame(true);
	}
}
